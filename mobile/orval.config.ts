...
/**
 * The same contract the other two clients are generated from,
 * `api/openapi.json`, turned into this client's own typed SDK.
 *
 * The one hand-written file is the mutator, `src/client/http.ts`, which knows
 * which server is current — the phone talks to several and the generated code
 * must not care which.
 *
