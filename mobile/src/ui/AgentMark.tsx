      ...
      return (
        <Svg width={size} height={size} viewBox="0 0 16 16">
          <Path
            ...
            fill="none"
          />
          <Path d="M8.4 11.4H13" stroke={tone} strokeWidth={1.6} strokeLinecap="round" />
        </Svg>
      );
  }
}
