...
export const ListHostsResponseItem = zod.object({
  ...
  "execution": zod.union([zod.null(),zod.enum(['container', 'host']).describe('Where the worker executes, resolved by the control plane.')]).optional(),
