...
import type { Agent, Host, Readiness, Requirement } from "~/api/generated/model";
import {
  useHostReadiness,
  useConnectHost,
  useInstallWorker,
} from "~/api/generated/hosts/hosts";
import { useInstallAgent } from "~/api/generated/agents/agents";
import { useQueryClient } from "@tanstack/react-query";
import { Copyable } from "~/components/ui";
import { connectionLabel, environmentLabel, executionOf } from "~/api/environments";
